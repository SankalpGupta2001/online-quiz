...
export const Admin = () => {
  ...
  return (
    <div>
      <div className="md:w-11/12 mx-auto bg-gray-100/10 flex p-4 my-6 mt-24">
        <div className="w-7/12 ">
          ...
          <div className=" ml-32 leading-normal">
            ...
            I'm competitive programmer and Full stack web development and I loves problem solving and i have strong skills in web technologies like Node js, MongoDB, Express js, React js
            </p>
          </div>
      ...
      <div className="border-red-500 absolute bg-yellow right-24 top-28 border-2 mb-8 p-1 pl-2  pr-2 ">
