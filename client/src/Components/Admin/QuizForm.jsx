    ...
    <div className="w-10/12 flex  text-slate-50">
      ...
      <div className="">
        <div className="flex text-black  w-96 font-bold font-serif mb-2 ml-12 mt-14">
          <h1 className="text-2xl ">ENTER QUESTIONS </h1>
        </div>
        <form className="-mt-6" >
          <label
          ...
          <div className="flex">
            ...
            <button
              ...
              className=" bg-transparent hover:bg-blue-500 text-black font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded  ml-36 "
            >
              Upload
            </button>
          </div>
