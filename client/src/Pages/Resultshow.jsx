    ...
    <div className=" w-11/12 shadow-2xl ml-16  mt-24">
      ...
      <div className="flex -mt-24">
        <div className="w-2/5 ml-4">
          <img src="https://assets.eleconomista.com.mx/__export/1594229157521/sites/eleconomista/img/2020/07/08/publirreportaje_quiz_time.jpg_673822677.jpg" alt="resultAnalysis" />
        </div>
